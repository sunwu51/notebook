...
- 2 爬取搜索引擎结果的`SERP(search engine result page) API`的供应商，如果`serpAPI`、`searper`、`searchAPI`等。 
...
| searper   | 2500次一次性额度 | 用量付费：最低充值额度是$1/k次 | rest, mcp | ❌️ | ❌️ | 未明确说明 | 需要邮箱 | 充值越多单次搜索均价会越低 |
