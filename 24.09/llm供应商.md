...
## 2.1 silicon cloud
硅基流动，国内的公司，在国内调用非常快，稳定，价格还便宜，10B以下模型都可以免费调用。目前主要是售卖gpu算力，没有开展api代理的工作，所以支持的模型都是开源的。如`qwen` `llama`等。`llama3.1`价格：
...
- 价格便宜，很多模型都会打折，例如`gpt`部分模型很多时候比官网价格还便宜！！
- 国内的模型比较多
- 充值和使用都非常方便
...
| open router | 海外 | 快 | 目前稳定 | ✔️ | ❌ | llama等 | 4o: ￥70/M 4o-mini:￥4.2/M llama3.1-70B-inst: ￥2/M |
| chatanywhere | 国内(但机器海外) | 快 | 目前稳定 | ✔️ | ✔️ | - | 4o: ￥105/M 4o-mini:￥4.2/M |
| V3 api | 国内(但机器海外) | 快 | 目前稳定 | ✔️ | ✔️ | qwen等 | 4o: ￥105/M 4o-mini:￥4.2/M |
